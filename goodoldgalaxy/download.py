...
class Download:
    ...
    def register_state_function(self,func = None, func_args = None):
        ...
        Args:
            func (lambda): Function that is invoked when the download changes state
            func_args (list): Function arguments
        """
        if func is None:
            return
    ...
    def set_progress(self, percentage: int) -> None:
        ...
        # we create a copy of the listeners to avoid issues with removals
        current_listeners = []
        for entry in self.__progress_funcs:
            current_listeners.append(entry)
        for entry in current_listeners:
            ...
            try:
                ...
                print("Could not set progress. Cause: {}".format(e))
    ...
    def error(self, e:Exception = None):
        ...
        for entry in current_listeners:
            ...
            try:
                ...
                print("Could not set progress. Cause: {}".format(e1))
    ...
    def cancel(self):
        ...
        for entry in current_listeners:
            ...
            try:
                ...
                print("Could not process cancel function. Cause: {}".format(e))

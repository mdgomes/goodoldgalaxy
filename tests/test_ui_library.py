...
sys.modules['gi'] = m_gi
sys.modules['goodoldgalaxy.ui.window'] = m_window
sys.modules['goodoldgalaxy.ui.preferences'] = m_preferences
sys.modules['goodoldgalaxy.ui.gametile'] = m_gametile
sys.modules['goodoldgalaxy.config'] = m_config

from goodoldgalaxy.ui.library import Library
...
del sys.modules['goodoldgalaxy.ui.window']
del sys.modules['goodoldgalaxy.ui.preferences']
del sys.modules['goodoldgalaxy.ui.gametile']
del sys.modules['goodoldgalaxy.config']
